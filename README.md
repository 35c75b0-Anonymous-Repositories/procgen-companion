...
This repo was anonymised by:

1. Creating an new anonymous GitHub organisation and anonymous repo, with default branch 'anon'
2. Creating a new branch 'anon' in the original repo
3. Removing all references in code and content files.
4. Squashing all commits into one <https://stackoverflow.com/questions/1657017/how-to-squash-all-git-commits-into-one>
5. Anonymising the Git commit with `git filter-branch -f --env-filter "GIT_AUTHOR_NAME='Newname'; GIT_AUTHOR_EMAIL='new@email'; GIT_COMMITTER_NAME='Newname'; GIT_COMMITTER_EMAIL='new@email';" HEAD`
...
`pip install git+https://github.com/35c75b0-Anonymous-Repositories/procgen-companion/procgen-companion.git`

or if you already installed it, maybe safer to like this:

`pip install --upgrade --force-reinstall git+https://github.com/35c75b0-Anonymous-Repositories/procgen-companion/procgen-companion.git`
